...
#### 1.3. Payment
The Client will pay the Contractor an fixed rate of **[$ AMOUNT]**. Of this, the Client will pay the Contractor **[DEPOSIT AMOUNT]** before work begins.
