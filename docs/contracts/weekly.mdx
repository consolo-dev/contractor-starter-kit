...
#### 1.2. Term
The Contractor will begin work on **[START DATE]** and end on **[END DATE]**.

#### 1.3. Payment
The Client will pay the Contractor an weekly rate of **[$ RATE / WEEK]** for a total of **[X HOURS PER WEEK]**. Of this, the Client will pay the Contractor **[DEPOSIT AMOUNT]** before work begins.

#### 1.4. Expenses
The Client will reimburse the Contractor’s expenses. Expenses do not need to be pre-approved by the Client.

#### 1.5. Invoices
The Contractor will invoice the Client **[WEEKLY / BI-WEEKLY]** starting on **[START BILLING DATE]** and ending on **[END BILLING DATE]**. The Client agrees to pay the Contractor in full within **[DAYS TO PAY]** days of receiving the invoice. Payment after that date will incur a late fee of **[LATE FEE]**.
